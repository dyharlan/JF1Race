...
public class TEXTURES{
    ...
    public TEXTURES() throws IOException{
             ...
             TEXTURE_NUMBER_3 = ImageIO.read(new File("assets/GAME_F1RACE_NUMBER_3.bmp"));
             TEXTURE_NUMBER_4 = ImageIO.read(new File("assets/GAME_F1RACE_NUMBER_4.bmp"));
             TEXTURE_NUMBER_5 = ImageIO.read(new File("assets/GAME_F1RACE_NUMBER_5.bmp"));
             TEXTURE_NUMBER_6 = ImageIO.read(new File("assets/GAME_F1RACE_NUMBER_6.bmp"));
